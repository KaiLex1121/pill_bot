...
Revision ID: 551c781ae2a1
Revises: 
Create Date: 2024-03-27 23:44:43.718330
...
def upgrade() -> None:
    ...
    sa.Column('delivery_type', sa.Enum('meeting', 'delivery', name='typeofdelivery'), nullable=False),
